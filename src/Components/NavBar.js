        ...
        <React.Fragment>
            ...
            <div className='navBar'>
                ...
                <ul className={this.state.clicked ?'navBar__list-clicked' : 'navBar__list' }> 
                    ...
                    <li className='navBar__list-li'>
                        <Link Link onClick={this.handleClickLi} to="about" spy={true} smooth={true} >
                            <label className='navBar__Label'>About me</label></Link></li>

                    <li className='navBar__list-li'>
                        <Link Link onClick={this.handleClickLi} to="skills" spy={true} smooth={true}  offset={-100} >
                            <label className='navBar__Label'>Skills</label></Link></li>

                    <li className='navBar__list-li'>
                        <Link Link onClick={this.handleClickLi} to="portfolio" spy={true} smooth={true} >
                        <label className='navBar__Label'>Portfolio</label></Link></li>
                    <li className='navBar__list-li'>
                        <Link Link onClick={this.handleClickLi} to="contact" spy={true} smooth={true} >
